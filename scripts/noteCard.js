...
export class NoteCard {
    ...
    constructor(){
        ...
        this.#card.style = 'margin-left: 10px;flex: 1 1 235px; border: 1px solid rgba(0,0,0,0.3); border-radius: 10px; height: relative; max-height: 400px; min-height: 100px;';
        ...
        this.#bottomSection.style = 'height: 50px; width: 100%; background-color: red;';

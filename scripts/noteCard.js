...
export class NoteCard {
    ...
    constructor(){
        ...
        this.#card.style = 'transition: 150ms; flex: 1 1 235px; border: 1px solid rgba(0,0,0,0.2); border-radius: 10px; height: auto; max-width: 300px; max-height: 400px; min-height: 100px;background-color: white;';
